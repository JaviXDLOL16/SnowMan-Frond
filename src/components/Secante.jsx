...
function Secante() {
    ...
    const resolve = (e) => {
        ...
        fetch('http://localhost:8080/secante/resolve', {
            method: 'POST',
            headers: {
        ...
        <div className='nr-main'>
                ...
                <form onSubmit={resolve}>
                    <section className='nr-form-div form-div'>
                        <div class="mb-3  nr-input-div input-value input">
                            <label for="SecanteValueA" class="form-label">Valor A</label>
                            <input type="number" step=".01" class="form-control" id="SecanteValueA" onChange={(e) => setValueA(e.target.value)} required />
                        </div>

                        <div class="mb-3  nr-input-div input-value input">
                            <label for="SecanteValueB" class="form-label">Valor B</label>
                            <input type="number" step=".01" class="form-control" id="SecanteValueB" onChange={(e) => setValueB(e.target.value)} required />
                        </div>

                        <div class="mb-3  nr-input-div input-func input">
                            <label for="SecanteFuncion" class="form-label">Función matemática</label>
                            <input type="text" class="form-control" id="SecanteFuncion" onChange={(e) => setFuncion(e.target.value)} required />
                        </div>

                        <div class="mb-3 nr-input-div input-tolerancia input">
                            <label for="SecanteTolerancia" class="form-label">Tolerancia de resultado</label>
                            <input type="number" step="0.0000001" class="form-control" id="SecanteTolerancia" onChange={(e) => setTol(e.target.value)} placeholder='Default: 0' />
                        </div>
            ...
            <section className='result-div'>
...

                {
                    funcionToG &&
                    <>
                        <button type="button" class="btn btn-primary btn-modal-func" data-bs-toggle="modal" data-bs-target="#modalS">
                            Gráfica de la función
                        </button>

                        <div class="modal fade" id="modalS" tabindex="-1" aria-labelledby="modalLabelS" aria-hidden="true">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="modalLabelS">Gráfica</h1>
